...
public class YG0301Request {
	 ...
	 * body object
	 */
	private YG0301Request_Body body = null;

	public YG0301Request() {
	}

	public YG0301Request(JsonAdaptorObject obj) {
		JsonNode rootNode = obj.get(JsonAdaptorObject.TYPE.REQUEST);
		JsonNode headerNode = rootNode.path("header");
		this.header = new YGHeader(headerNode);
		JsonNode bodyNode = rootNode.path("body");
		this.body = new YG0301Request_Body(bodyNode);
	}
	...
	@JsonProperty("body")
	public YG0301Request_Body getBody() {
		return this.body;
	}

	public void setBody(YG0301Request_Body body) {
		this.body = body;
	}
