...
public class YG0200Request {
	 ...
	 * body object
	 */
	private YG0200Request_Body body = null;

	public YG0200Request() {
	}

	public YG0200Request(JsonAdaptorObject obj) {
		JsonNode rootNode = obj.get(JsonAdaptorObject.TYPE.REQUEST);
		JsonNode headerNode = rootNode.path("header");
		this.header = new YGHeader(headerNode);
		JsonNode bodyNode = rootNode.path("body");
		this.body = new YG0200Request_Body(bodyNode);
	}
	...
	@JsonProperty("body")
	public YG0200Request_Body getBody() {
		return this.body;
	}

	public void setBody(YG0200Request_Body body) {
		this.body = body;
	}
