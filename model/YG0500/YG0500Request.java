...
public class YG0500Request {
	 ...
	 * body object
	 */
	private YG0500Request_Body body = null;

	public YG0500Request() {
	}

	public YG0500Request(JsonAdaptorObject obj) {
		JsonNode rootNode = obj.get(JsonAdaptorObject.TYPE.REQUEST);
		JsonNode headerNode = rootNode.path("header");
		this.header = new YGHeader(headerNode);
		JsonNode bodyNode = rootNode.path("body");
		this.body = new YG0500Request_Body(bodyNode);
	}
	...
	@JsonProperty("body")
	public YG0500Request_Body getBody() {
		return this.body;
	}

	public void setBody(YG0500Request_Body body) {
		this.body = body;
	}
