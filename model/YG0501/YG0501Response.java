...
public class YG0501Response {
	 ...
	 * body object
	 */
	private YG0501Response_Body body = null;

	public YG0501Response() {
	}

	public YG0501Response(JsonAdaptorObject obj) {
		JsonNode rootNode = obj.get(JsonAdaptorObject.TYPE.RESPONSE);
		JsonNode headerNode = rootNode.path("header");
		this.header = new YGHeader(headerNode);
		JsonNode bodyNode = rootNode.path("body");
		this.body = new YG0501Response_Body(bodyNode);
	}
	...
	@JsonProperty("body")
	public YG0501Response_Body getBody() {
		return this.body;
	}

	public void setBody(YG0501Response_Body body) {
		this.body = body;
	}
