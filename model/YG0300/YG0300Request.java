...
public class YG0300Request {
	 ...
	 * body object
	 */
	private YG0300Request_Body body = null;

	public YG0300Request() {
	}

	public YG0300Request(JsonAdaptorObject obj) {
		JsonNode rootNode = obj.get(JsonAdaptorObject.TYPE.REQUEST);
		JsonNode headerNode = rootNode.path("header");
		this.header = new YGHeader(headerNode);
		JsonNode bodyNode = rootNode.path("body");
		this.body = new YG0300Request_Body(bodyNode);
	}
	...
	@JsonProperty("body")
	public YG0300Request_Body getBody() {
		return this.body;
	}

	public void setBody(YG0300Request_Body body) {
		this.body = body;
	}
