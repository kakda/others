...
public class YG0401Request {
	 ...
	 * body object
	 */
	private YG0401Request_Body body = null;

	public YG0401Request() {
	}

	public YG0401Request(JsonAdaptorObject obj) {
		JsonNode rootNode = obj.get(JsonAdaptorObject.TYPE.REQUEST);
		JsonNode headerNode = rootNode.path("header");
		this.header = new YGHeader(headerNode);
		JsonNode bodyNode = rootNode.path("body");
		this.body = new YG0401Request_Body(bodyNode);
	}
	...
	@JsonProperty("body")
	public YG0401Request_Body getBody() {
		return this.body;
	}

	public void setBody(YG0401Request_Body body) {
		this.body = body;
	}
