...
public class YG0401Response {
	 ...
	 * body object
	 */
	private YG0401Response_Body body = null;

	public YG0401Response() {
	}

	public YG0401Response(JsonAdaptorObject obj) {
		JsonNode rootNode = obj.get(JsonAdaptorObject.TYPE.RESPONSE);
		JsonNode headerNode = rootNode.path("header");
		this.header = new YGHeader(headerNode);
		JsonNode bodyNode = rootNode.path("body");
		this.body = new YG0401Response_Body(bodyNode);
	}
	...
	@JsonProperty("body")
	public YG0401Response_Body getBody() {
		return this.body;
	}

	public void setBody(YG0401Response_Body body) {
		this.body = body;
	}
