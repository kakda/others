...
public class YG0202Request {
	 ...
	 * body object
	 */
	private YG0202Request_Body body = null;

	public YG0202Request() {
	}

	public YG0202Request(JsonAdaptorObject obj) {
		JsonNode rootNode = obj.get(JsonAdaptorObject.TYPE.REQUEST);
		JsonNode headerNode = rootNode.path("header");
		this.header = new YGHeader(headerNode);
		JsonNode bodyNode = rootNode.path("body");
		this.body = new YG0202Request_Body(bodyNode);
	}
	...
	@JsonProperty("body")
	public YG0202Request_Body getBody() {
		return this.body;
	}

	public void setBody(YG0202Request_Body body) {
		this.body = body;
	}
