...
Date.prototype.diffPrevious = function(previous){
	var one_day=1000*60*60*24;
	return Math.ceil((this.getTime()-previous.getTime())/(one_day));
};

Date.prototype.diffMonths = function(previous){
	var diffDays = this.diffPrevious(previous);
...
function timeToString(long){
	return new Date(long).toString("yyyy-MM-dd");
};
